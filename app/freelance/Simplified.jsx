    ...
    <section className="w-full min-h-[80vh] bg-gradient-to-tr from-white to-blue-100 flex flex-col items-center justify-center px-6 py-16">
      ...
      <div className="text-center max-w-3xl">
        <h1 className="text-3xl md:text-5xl font-extrabold text-black">
          <span className="text-blue-600">Freelancing, Simplified:</span> Focus on Work, Not the Hassle
        </h1>
      ...
      <div className="mt-12 space-y-12 w-full max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold">Effortless Hiring & Collaboration</h2>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold">Escrow Payment Management: Secure Payments & Smart Investments</h2>
            <p className="mt-2 text-lg text-gray-600">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div className="text-center md:text-left">
            <h2 className="text-2xl font-bold">More Freedom, Less Admin Work</h2>
            <p className="mt-2 text-lg text-gray-600">

...
//             transform hover:scale-105 transition-all duration-300" onClick={() => router.push("/login/signup")}>
//             🚀 Hire Now
//           </button>
//         </div>
//       </div>
  ...
  return (
    <section className="flex items-center justify-center min-h-[80vh] bg-gradient-to-r from-black to-blue-900 px-4 sm:px-6 py-20 sm:py-12">
      <div className="text-white max-w-3xl text-center space-y-6 px-4 sm:px-0">
        ...
        {/* Call to Action Button */}
        <div>
          <button className="px-8 py-3 sm:py-4 text-lg sm:text-xl font-semibold text-white 
            bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg 
            hover:from-blue-400 hover:to-purple-500 hover:shadow-xl 
            transform hover:scale-105 transition-all duration-300" onClick={() => router.push("/login/signup")}>
            🚀 Hire Now
